...
interface IButtonIconProps
  extends Pick<React.ComponentProps<'button'>, 'children' | 'onClick' | 'className'> {}
...
function ButtonIcon(props: IButtonIconProps) {
  return (
    <Button
      variant="ghost"
      size="icon"
      className={cn('cursor-pointer hover:bg-gray-200 size-6', props.className)}
