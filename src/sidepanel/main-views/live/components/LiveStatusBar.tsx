      ...
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          <Tooltip>
            ...
            <Tooltip.Content side="top" sideOffset={8} className="max-w-56 rounded-xl bg-slate-900 px-3 py-2 text-[11px] text-slate-50 shadow-lg">
          ...
          <Tooltip>
            ...
            <Tooltip.Content side="top" sideOffset={8} className="rounded-xl bg-slate-900 px-3 py-2 text-[11px] text-white shadow-lg">
